                      ...
                      new Decimal("1").plus(
                        new Decimal(methodThis._OAAHent.getValue()).times(
                          new Decimal("3.603787e-9")
                            ...
                            .plus(
                              new Decimal("0.0004185884").times(
                                new Decimal(methodThis._ENin.getValue()).pow(
                                  new Decimal("2")
                                )
                              )
                            ...
                            .minus(
                              new Decimal("0.04652773").times(
                                new Decimal(methodThis._ENin.getValue())
                              )
                            )
                            .plus(new Decimal("2.887669"))
                        )
                      )
                    )
                );
